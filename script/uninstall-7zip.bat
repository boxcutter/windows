...
if exist "%SystemRoot%\7z.exe" (
    del /f "%SystemRoot%\7z.exe"
)
if exist "%SystemRoot%\7z.dll" (
    del /f "%SystemRoot%\7z.dll"
)

if not exist "%_7z_path%" (
    goto delete_sevenzip
)

call :run msiexec /qb /x "%_7z_path%"
