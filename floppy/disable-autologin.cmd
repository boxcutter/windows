...
:: source: https://github.com/joefitzgerald/packer-windows/blob/master/scripts/disable-auto-logon.bat

call :run reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon" /v AutoAdminLogon /d 0 /f
