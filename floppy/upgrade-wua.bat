...
call :download "%WUA_URL%"
if %ERRORLEVEL% neq 0 (
    goto exit
)

:: see https://blogs.technet.microsoft.com/enterprisemobility/2014/07/14/how-to-install-the-windows-update-agent-on-client-computers/

call :run "%downloaded_file%" /quiet /norestart /wuforce
