...
call :run netsh advfirewall firewall set rule group="File and Printer Sharing" new enable=Yes

call :run netsh advfirewall firewall set rule group="Network Discovery" new enable=Yes

call :run netsh advfirewall set currentprofile state on
