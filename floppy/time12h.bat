...
call :run reg add "HKCU\Control Panel\International" /f /v sShortTime /t REG_SZ /d "h:mm tt"
call :run reg add "HKCU\Control Panel\International" /f /v sTimeFormat /t REG_SZ /d "h:mm:ss tt"
