...
call :run powercfg -hibernate OFF

call :run reg add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v HibernateFileSizePercent /t REG_DWORD /d 0 /f

call :run reg add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v HibernateEnabled /t REG_DWORD /d 0 /f
