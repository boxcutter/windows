...
call :run reg add "HKCU\Software\Policies\Microsoft\Windows\Control Panel\Desktop\" /v ScreenSaveTimeOut /t REG_DWORD /d 0 /f

call :run reg add "HKCU\Software\Policies\Microsoft\Windows\Control Panel\Desktop\" /v  ScreenSaveActive /t REG_DWORD /d 0 /f

call :run reg add "HKEY_USERS\.DEFAULT\Control Panel\Desktop\" /v  ScreenSaveActive /t REG_DWORD /d 0 /f
