...
call :run reg add "HKCU\Control Panel\International" /f /v sShortTime /t REG_SZ /d "HH:mm"
call :run reg add "HKCU\Control Panel\International" /f /v sTimeFormat /t REG_SZ /d "HH:mm:ss"
